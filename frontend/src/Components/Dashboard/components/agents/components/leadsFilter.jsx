...
function LeadsFilter({
  ...
  const [filterAgents, { loading, data, error }] =
    useLazyQuery(FILTER_LEAD_QUERY);
  ...
  const handleSubmit = async (event) => {
    ...
    const filter = {
    //   name: filterFormData.name || undefined,
      phone: filterFormData.phone || undefined,
      email: filterFormData.email || undefined,
      postal_code: filterFormData.postal_code || undefined,
      city: filterFormData.city || undefined,
      state: filterFormData.state || undefined,
      full_address: filterFormData.full_address || undefined,
      insuranceType: filterFormData.insuranceType || undefined,
      leadsCount: filterFormData.leadsCount
        ? parseInt(filterFormData.leadsCount, 10)
        : undefined,
      targetedAudience: filterFormData.targetedAudience || undefined,
 ...
 <label>Email</label>
          ...
          <input
            ...
            placeholder="Postal"
            name="postal_code"
            value={filterFormData.postal_code || ""}
            onChange={(e) =>
              setFilterFormData({
                ...filterFormData,
          ...
          <input
            ...
            placeholder="Address"
            name="full_address"
            value={filterFormData.full_address || ""}
            onChange={(e) =>
              setFilterFormData({
                ...filterFormData,
